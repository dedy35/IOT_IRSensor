...
//link kirim http
String host = "http://internalhonicelindonesia.co.id";
//HTTPClient http;
...
void kirim_datahttp()
{
  String postData = (String)"count=" + count;
  HTTPClient http;
  http.begin(espClient, "http://internalhonicelindonesia.co.id");
  http.addHeader("Content-Type", "application/x-www-form-urlencode");
  auto httpCode = http.POST(postData);
  String payloadhttp = http.getString();
  Serial.println(postData);
  Serial.println(payloadhttp);
...
void loop()
{
  ...
  // //       String postData = (String)"count=" + count;
  // // HTTPClient http;
  // // http.begin(clienthttp, "http://internalhonicelindonesia.co.id");
  // // http.addHeader("Content-Type", "application/x-www-form-urlencode");
  // // auto httpCode = http.POST(postData);
  // // String payloadhttp = http.getString();
  // // Serial.println(postData);
